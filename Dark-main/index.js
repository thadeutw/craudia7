	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'meliodas':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/fi3FE4x`)
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 'se liga no peitoral do pai'})
					break
					case 'pedro':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/J5badsc`)
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 'macaco agiota️'})
					break
					case 'mendingo':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/undefined`)
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 'eren mendingo passando na sua tela agora vc me deve 1 real.'})
					break
					case 'tixa':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/RUyPilO`)
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 'oieeeeeee'})
					break
					case 'tmnc':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/0djMzTp`)
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 's2'})
					break
					case 'solador':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/bwCeCkg`)
					client.sendMessage(from, buffer, video, {quoted: mek, caption: 'el soladoro brabo'})
					break
				case 'memeindo':
					memein = await kagApi.memeindo()
